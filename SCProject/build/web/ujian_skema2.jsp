<%-- 
    Document   : ujian_skema2
    Created on : Dec 19, 2020, 9:57:32 AM
    Author     : syazlyn
--%>
...
<%
        ...
        ResultSet rs = stmt1.executeQuery("SELECT * FROM jawapanujianuser WHERE userID='"+userID+"'AND setujian=2"); 
...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center">Semakan Ujian 2</h1>
    
        <h3> Markah anda ialah <% out.println(markah) ;%>/3 </h3>
            <tr><td>SOALAN  </td> <td> <img src="images/uji1.png" <br>
            <br><label>       Rajah 1 </label><br><br>
            <label>Berdasarkan Rajah 1, adakah jenis data AutoNumber yang disetkan untuk ID_Murid merupakan satu pilihan yang tepat? Pilih jawapan yang betul </label><br></td> </tr>
            ...
            <tr><td>SOALAN  </td> <td>  <label>Berdasarkan Rajah 1, jika AutoNumber tidak digunakan, apakah jenis data lain yang sesuai?</label><br></td> </tr>
            <tr><td>JAWAPAN </td> <td> Jawapan anda: <br>  <%  if (skema2.contains("BETUL.")== true){%> <p style="color:green"> <% out.println(ques2); %>  </p>
             ...
             <tr><td>SOALAN  </td> <td> <label>Anda telah diberikan satu borang yang mengandungi maklumat seperti nama, jantina, nombor telefon dan alamat
       ...
       <div class="form-submit">
        ...
        <button class="learn-more" onclick="document.location='ujian2.jsp'"><span>Cuba Lagi</span></button><br>
       </div> 
       </div>
        </div>
        </div>
