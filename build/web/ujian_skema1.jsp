<%-- 
    Document   : ujian_skema1
    Created on : Dec 15, 2020, 5:12:23 PM
    Author     : syazlyn
--%>
...
<%
        ...
        ResultSet rs = stmt1.executeQuery("SELECT * FROM jawapanujianuser WHERE userID='"+userID+"'AND setujian=1"); 
...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center">Semakan Ujian 1</h1>
    
        <h3> Markah anda ialah <% out.println(markah) ;%>/3 </h3>
            <tr><td>SOALAN  </td> <td>  Anda telah diberikan satu borang yang mengandungi maklumat seperti nama, jantina, nombor telefon dan alamat
            ...
            <tr><td>SOALAN  </td> <td>  Pangkalan data yang menghasilkan sistem maklumat yang efisien direka bentuk melalui beberapa
                fasa. Pilih fasa-fasa dalam pembangunan sistem maklumat yang SALAH.</td> </tr>
       ...
       <div class="form-submit">
        ...
        <button class="learn-more" onclick="document.location='ujian1.jsp'"><span>Cuba Lagi</span></button><br>
       </div> 
       </div>
        </div>
        </div>
