<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('dashboard') }}"> <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('stores.store') }}">
            <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-building-store" width="20"
    ...
    <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{ url('order') }}">
            <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{ route('supply') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{ route('totalsales') }}">
            <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-coin" width="20"
                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#finance-menu" role="button" aria-expanded="false"
            ...
            <span class="item-name">Finances</span>
            <i class="right-icon">
        ...
        <ul class="sub-nav collapse" id="finance-menu" data-bs-parent="#sidebar">
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('transaction') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clipboard-list" width="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <li class=" nav-item ">
                <a class="nav-link " href="{{ route('finance.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clipboard-plus" width="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2"></path>
                            <rect x="9" y="3" width="6" height="4" rx="2"></rect>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('staff.index') }}"> <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ url('/accounts') }}"> <i class="icon">
                <svg width="23" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M11.9488 14.54C8.49884 14.54 5.58789 15.1038 5.58789 17.2795C5.58789 19.4562 8.51765 20.0001 11.9488 20.0001C15.3988 20.0001 18.3098 19.4364 18.3098 17.2606C18.3098 15.084 15.38 14.54 11.9488 14.54Z"
                        fill="currentColor"></path>
